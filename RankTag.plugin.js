//META{"name":"Rank Tag","website":"https://github.com/mwittrien/BetterDiscordAddons/tree/master/Plugins/OwnerTag","source":"https://raw.githubusercontent.com/JohnJ0ng/BetterDiscordAddons/master/RankTag.plugin.js"}*//

class OwnerTag {
	getName () {return "Rank Tag";}

	getVersion () {return "1.0.0";}

	getAuthor () {return "John Jong";}

	getDescription () {return "Adds a tag similar to bot tags to every user with their highest role. (This is a modified version of DevilBros ownertag addon! (I will link the website to his original addon))";}

	initConstructor () {
		this.changelog = {
			"change":[["Changed Everything","what the title says"]]
		};
	...
	processNameTag (instance, wrapper) {
		...
		else if ((container = BDFDB.getParentEle(BDFDB.dotCN.userprofile, wrapper)) != null && BDFDB.getData("addInUserProfile", this, "settings")) {
